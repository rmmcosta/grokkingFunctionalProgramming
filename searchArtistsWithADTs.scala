...
def goodArtists = List(
  ...
  Artist("Led Zepplin", HardRock, Location("England"), 1980, false, 1990),
...
trait Genre(val name: String) {}
case object AlternativeRock extends Genre("Alternative Rock")
case object HardRock extends Genre("Hard Rock")
case object Rock extends Genre("Rock")
